...
- Supports 0–3 NHT applicants and only shows the selected number of applicant cards.
- Divides a total NHT loan equally across selected applicants while keeping manual applicant edits synchronized with the total.
...
- Includes a car-loan calculator with rolling vehicle-year options, year-based default rates, switchable month/year terms, editable bank terms, and a live payment estimate.
